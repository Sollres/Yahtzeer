...
void combinaison_f(t_main m,fiche_score *score_o, int relance){
	...
	/*score_o->total_i = score_o->t_un + score_o->t_deux + score_o->t_trois + score_o->t_quatre + score_o->t_cinq + score_o->t_six;
	score_o->total_ii = score_o->brelan + score_o->carre + score_o->full + score_o->petite_s + score_o->gde_s + score_o->yams + score_o->chance;
	score_o->total = score_o->total_i + score_o->total_ii;*/
